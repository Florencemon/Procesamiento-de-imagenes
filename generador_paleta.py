...
class GeneradorPaletas:
    ...
    def generar_paletas(self):
        return {
            "Complementaria": {"descripcion": "Impacto inmediato y alto contraste.Orientada a captar interés de forma inmediata y sostener la atención.",
                "colores": self.generar_complementaria()
            },
            "Análoga": {"descripcion": "Armonía visual y coherencia. Perfecta para transmitir calma, confianza y una estética cuidada.",
                "colores": self.generar_analogos()
            },
            "Triádica": {"descripcion": "Equilibrio dinámico y versatilidad.Combina energía y balance, ideal para marcas creativas y modernas.",
